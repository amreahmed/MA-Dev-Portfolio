  ...
  return (
    <div className="py-20" id="projects">
      <h1 className="heading">
        A Small Selection of our <span className="text-purple">recent projects</span>
      </h1>
        ...
        {projects.map(({ id, title, img, des, iconLists, link }) => (
          <div
            ...
            <PinContainer title={link} href={link}>
              <div className="relative flex items-center justify-center  w-[80vw] overflow-hidden mb-10 sm:w-[570px] sm:h-[40vh] h-[30vh]">
